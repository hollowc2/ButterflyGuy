# Graph Report - butterflyguy  (2026-05-14)

## Corpus Check
- 108 files · ~282,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1559 nodes · 2646 edges · 119 communities (104 shown, 15 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 736 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc0380ba`
...
8. `StrategySettings` - 33 edges
9. `main()` - 32 edges
10. `ButterflySelector` - 31 edges
...
Cohesion: 0.06
Nodes (56): BaseModel, CollectorSettings, DatabaseSettings, EntrySettings, ExecutionSettings, MonitoringSettings, ProfitManagementSettings, QuoteQualitySettings (+48 more)
...
Cohesion: 0.11
Nodes (23): DayResult, DrawdownWindow, _profit_exit_reason(), Single-day simulation engine using synthetic option chains., Simulate intraday using BS pricing, pinned to a pre-selected real entry., Simulate intraday using BS pricing, pinned to a pre-selected real entry., Simulate intraday using BS pricing, pinned to a pre-selected real entry., Maps Regime → SimulationParams for use with simulate_day_adaptive().      Per-re (+15 more)
...
Cohesion: 0.09
Nodes (23): _drawdown_rule(), get_0dte_expiration(), get_time_regime(), minutes_since_open(), minutes_to_close(), now_eastern(), now_pacific(), Market timezone helpers for 0-DTE trading. (+15 more)
...
Cohesion: 0.14
Nodes (19): load_config(), Load configuration from YAML file and environment variables., Load configuration from YAML file and environment variables., daily_reset_loop(), entry_loop(), Main orchestrator: runs collector + trading + position monitor concurrently., Periodically attempt entries during the entry window., Reset daily risk state at market open. (+11 more)
...
Cohesion: 0.13
Nodes (15): Simulate one trading day., Simulate one trading day., ButterflyCandidate, fly_mark_value(), Pydantic models for option data and trade records., Butterfly value at mark: lower.mark - 2*center.mark + upper.mark., A butterfly spread candidate identified by the scanner., A trade record for tracking entry/exit. (+7 more)
...
Cohesion: 0.14
Nodes (12): ButterflySelector, Butterfly selector — picks the best candidate from a list., Selects the best butterfly candidate., Select the candidate whose cost is closest to its max_cost_per_width., Select the best butterfly candidate.          When `target_center` is provided (, Select the candidate whose cost is closest to its max_cost_per_width., Select the farthest OTM candidate from the already-valid candidate set., make_candidate() (+4 more)
...
Cohesion: 0.17
Nodes (12): get_recent_closes(), merge_chains(), Merge entry-window (all strikes) and monitoring (3 strikes, full day) chains., Merge entry-window (all strikes) and monitoring (3 strikes, full day) chains., Merge entry-window (all strikes) and monitoring (3 strikes, full day) chains., Merge entry-window (all strikes) and monitoring (3 strikes, full day) chains., Up to *n* daily closes strictly before *date*, chronological order., Up to *n* daily closes strictly before *date*, chronological order. (+4 more)
...
Cohesion: 0.29
Nodes (7): get_vix_prev_close(), Return VIX daily close strictly before *date* from daily_bars., Return VIX daily close strictly before *date* from daily_bars., Up to *n* daily closes strictly before *date*, chronological order., Return VIX daily close strictly before *date* from daily_bars., Return VIX daily close strictly before *date* from daily_bars., Return VIX daily close strictly before *date* from daily_bars.

### Community 79 - "Community 79"
Cohesion: 0.29
Nodes (7): load_monitoring_chains(), Load full-day snapshots for specific strikes only (3 legs of a butterfly)., Load full-day snapshots for specific strikes only (3 legs of a butterfly)., Load full-day snapshots for specific strikes only (3 legs of a butterfly)., Load full-day snapshots for specific strikes only (3 legs of a butterfly)., Load full-day snapshots for specific strikes only (3 legs of a butterfly)., Load full-day snapshots for specific strikes only (3 legs of a butterfly).
...
Cohesion: 0.33
Nodes (6): _bucket_sigmas(), Return sigma anchors spanning narrow to wide for the bucket size., Return (widths, sigma_fractions) for the active VIX bucket.      Buckets are pro, Return (widths, sigma_fractions) for the active VIX bucket.      Buckets are pro, resolve_wing_widths_for_vix(), test_two_width_vix_bucket_spans_narrow_and_wide_sigmas()
...
- **Why does `OptionQuote` connect `Community 3` to `Community 0`, `Community 1`, `Community 34`, `Community 4`, `Community 46`, `Community 79`, `Community 16`, `Community 17`, `Community 21`, `Community 22`, `Community 55`, `Community 53`, `Community 25`, `Community 27`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 27` to `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 17`, `Community 18`, `Community 21`, `Community 23`, `Community 25`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 47`, `Community 59`, `Community 61`, `Community 67`, `Community 80`, `Community 86`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `ButterflyCandidate` connect `Community 27` to `Community 0`, `Community 1`, `Community 3`, `Community 35`, `Community 40`, `Community 9`, `Community 13`, `Community 17`, `Community 51`, `Community 21`, `Community 25`, `Community 30`, `Community 31`?**
