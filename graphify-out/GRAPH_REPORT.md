# Graph Report - butterflyguy  (2026-05-12)

## Corpus Check
- 107 files · ~281,289 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1442 nodes · 2483 edges · 120 communities (105 shown, 15 thin omitted)
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 712 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63be8df2`
...
7. `ButterflyBuilder` - 34 edges
8. `main()` - 32 edges
9. `StrategySettings` - 30 edges
10. `ProfitStateMachine` - 29 edges
...
Cohesion: 0.05
Nodes (29): get_logger(), Structured logging setup with structlog., Configure structlog with JSON output and correlation IDs., Get a structlog logger with optional name., setup_logging(), Prometheus metrics for monitoring., Start the Prometheus metrics HTTP server., start_metrics_server() (+21 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (43): effective_drawdown_threshold(), ProfitPolicyDecision, profitprotector_floor_decision(), Shared profit-management policy helpers for live trading and backtests., Return a profit-floor exit once a configured peak gain has been reached., Return the active trailing drawdown threshold for the selected policy., ProfitStateMachine, Transition between profit states. (+35 more)
...
Cohesion: 0.06
Nodes (39): BaseSettings, AppConfig, load_config(), Load configuration from YAML file and environment variables., Load configuration from YAML file and environment variables., OptionChainCollector, Option chain collector — fetches and stores SPX chain snapshots., Fetch and store daily OHLCV bars for SPX and VIX. Runs once per calendar day. (+31 more)
...
Cohesion: 0.12
Nodes (27): max_consecutive_losses(), max_drawdown(), profit_factor(), Shared metrics for backtest sweep scripts., sharpe(), win_pct(), main(), parse_args() (+19 more)
...
Cohesion: 0.12
Nodes (25): OptionQuote, A single option quote from a chain snapshot., main(), Walk the 10:00-10:30 ET window and record every bar's entry signals., scan_entry_window(), EntryDecision, find_entry_candidate(), LiveSpread (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (23): DayResult, _drawdown_rule(), DrawdownWindow, _profit_exit_reason(), Single-day simulation engine using synthetic option chains., Runs full strategy on a single day using synthetic options., Runs full strategy on a single day using synthetic options., Simulate one trading day. (+15 more)
...
Cohesion: 0.12
Nodes (13): Enum, ExitSignal, ProfitState, Profit management state machine for butterfly positions., GapRegimeFilter, Market regime classifier for 0-DTE butterfly parameter dispatch.  Classifies eac, Regime, Unit tests for GapRegimeFilter.apply(). (+5 more)
...
Cohesion: 0.16
Nodes (15): now_utc(), iter_chain_options(), Shared utilities for parsing Schwab option chain responses., Yield (strike, option_type, opt_dict) for each option matching the expiration., OrderManager, Place one butterfly order at limit_price. Wait for fill; cancel if unfilled., Execute entry with price ladder: reprice from live mark each step,         step, Execute exit with reverse price ladder: reprice from live mark each step, (+7 more)
...
Cohesion: 0.11
Nodes (17): get_0dte_expiration(), minutes_since_open(), minutes_to_close(), now_eastern(), now_pacific(), Market timezone helpers for 0-DTE trading., Current time in US/Eastern., Current time in US/Pacific. (+9 more)
...
Cohesion: 0.2
Nodes (12): _dd_schedule_label(), _find_bar_at(), main(), nearest_snapshot(), parse_args(), _parse_dd_schedule(), _print_comparison_table(), _pst_to_et() (+4 more)
...
Cohesion: 0.21
Nodes (14): BaseModel, CollectorSettings, DatabaseSettings, EntrySettings, ExecutionSettings, MonitoringSettings, ProfitManagementSettings, ProfitProtectorSettings (+6 more)
...
Cohesion: 0.16
Nodes (10): A trade record for tracking entry/exit., TradeRecord, CandidateQueries, DecisionQueries, Queries for decision_log table., Queries for butterfly_candidates table., main(), Orchestrates the full entry/exit trading flow. (+2 more)
...
Cohesion: 0.23
Nodes (9): SimulationParams, test_drawdown_rule_prefers_explicit_schedule_when_present(), test_drawdown_rule_uses_legacy_regimes_by_default(), test_profitprotector_backtest_profit_floor_reason(), test_profitprotector_backtest_tightens_large_peak_drawdown(), use_bias_filter=True should produce a trade result (direction set by bias)., direction_override takes precedence over use_bias_filter., When bias filter always returns None, day should be untraded. (+1 more)
...
Cohesion: 0.14
Nodes (14): get_prev_close(), get_recent_closes(), get_vix_at(), load_bars_from_db(), load_date_data(), Return the last spot price at or before 16:00 ET on the previous trading day., Return the last spot price at or before 16:00 ET on the previous trading day., Up to *n* daily closes strictly before *date*, chronological order. (+6 more)
...
Cohesion: 0.14
Nodes (6): DatabasePool, Async database connection pool using asyncpg., Manages an asyncpg connection pool for TimescaleDB., Create the connection pool., Queries for spot_prices table., SpotQueries

### Community 41 - "Community 41"
Cohesion: 0.3
Nodes (12): StrategySettings, make_chain(), make_quote(), Tests for the butterfly builder scanner., Generate a synthetic chain of call quotes around spot., test_builder_breakevens_valid(), test_builder_cost_filter(), test_builder_cost_positive() (+4 more)
...
Cohesion: 0.15
Nodes (7): DailyBarQueries, Database query helpers for all tables., Queries for daily_bars table., Upsert daily OHLCV rows. Updates close/open/high/low/volume on conflict., Return the last `days` daily closes in chronological order (oldest first)., Queries for tent_boundaries table., TentQueries
...
Cohesion: 0.22
Nodes (7): Full entry flow from eligibility checks through entry fill., Parse Schwab chain response into OptionQuote objects., Parse Schwab chain response into OptionQuote objects., Parse Schwab chain response into OptionQuote objects., Full entry flow: time → balance → risk → direction (once) → retry loop (re-scan, Return (widths, sigma_fractions) for the active VIX bucket.      Buckets are pro, resolve_wing_widths_for_vix()
...
Cohesion: 0.29
Nodes (6): ButterflyCandidate, fly_mark_value(), Pydantic models for option data and trade records., Butterfly value at mark: lower.mark - 2*center.mark + upper.mark., A butterfly spread candidate identified by the scanner., O(N*W) scan: for each center strike within spot_range, for each wing_width,

### Community 66 - "Community 66"
Cohesion: 0.25
Nodes (8): Select the best butterfly candidate for a single wing width., Select the best butterfly candidate for a single wing width., Select the best butterfly candidate for a single wing width., Cross-width selection., Cross-width selection., Cross-width selection., select_for_width(), select_live_width()
...
Cohesion: 0.33
Nodes (4): CsvDataLoader, Loads SPX + VIX 1-minute CSVs and serves DayData objects.      Loads both files, DayData, Backtest data loader — fetches SPX 1-min bars and VIX from Polygon.io.
...
Cohesion: 0.33
Nodes (5): daily_reset_loop(), entry_loop(), Main orchestrator: runs collector + trading + position monitor concurrently., Periodically attempt entries during the entry window., Reset daily risk state at market open.
...
Cohesion: 0.4
Nodes (5): _print_same_entry_comparison_table(), Print real vs same-entry-synthetic comparison (pinned center/price, BS intraday, Print real vs same-entry-synthetic comparison (pinned center/price, BS intraday, Print real vs same-entry-synthetic comparison (pinned center/price, BS intraday, Print real vs same-entry-synthetic comparison (pinned center/price, BS intraday

### Community 76 - "Community 76"
Cohesion: 0.4
Nodes (5): print_thinkback_checklist(), Print a per-trade ToS ThinkBack validation checklist., Print a per-trade ToS ThinkBack validation checklist., Print a per-trade ToS ThinkBack validation checklist., Print a per-trade ToS ThinkBack validation checklist.
...
Cohesion: 0.5
Nodes (3): Fetch today's 1-min bars from Schwab and run BiasScoreFilter., Fetch today's 1-min bars from Schwab and run BiasScoreFilter., Fetch today's 1-min bars from Schwab and run BiasScoreFilter.
...
Cohesion: 0.5
Nodes (4): _force_synthetic_for_date(), Patch load_chain_day to return None for `date`, forcing BS synthetic fallback., Patch load_chain_day to return None for `date`, forcing BS synthetic fallback., Patch load_chain_day to return None for `date`, forcing BS synthetic fallback.
...
Cohesion: 0.5
Nodes (4): _patch_chain_cache(), Inject DB chains into the chain cache for `date`. Returns restore callable., Inject DB chains into the chain cache for `date`. Returns restore callable., Inject DB chains into the chain cache for `date`. Returns restore callable.

### Community 86 - "Community 86"
Cohesion: 0.5
Nodes (4): get_vix_prev_close(), Return VIX daily close strictly before *date* from daily_bars., Return VIX daily close strictly before *date* from daily_bars., Return VIX daily close strictly before *date* from daily_bars.
...
- **Why does `OptionQuote` connect `Community 10` to `Community 65`, `Community 33`, `Community 2`, `Community 4`, `Community 37`, `Community 6`, `Community 39`, `Community 41`, `Community 44`, `Community 16`, `Community 48`, `Community 19`, `Community 56`, `Community 57`, `Community 25`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `TradeService` connect `Community 33` to `Community 0`, `Community 65`, `Community 32`, `Community 3`, `Community 10`, `Community 43`, `Community 13`, `Community 78`, `Community 17`, `Community 18`, `Community 51`, `Community 20`, `Community 55`, `Community 56`, `Community 27`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 33` to `Community 0`, `Community 65`, `Community 3`, `Community 72`, `Community 40`, `Community 10`, `Community 11`, `Community 44`, `Community 45`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 51`, `Community 52`, `Community 27`?**
...
- **Are the 39 inferred relationships involving `str` (e.g. with `make_chain_data()` and `make_chain_data_with_spread()`) actually correct?**
