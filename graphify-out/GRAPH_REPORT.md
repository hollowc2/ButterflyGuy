...
## Corpus Check
- 108 files · ~282,246 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1562 nodes · 2652 edges · 114 communities (98 shown, 16 thin omitted)
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 738 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad0be47a`
...
- `TestEma` --uses--> `BiasScoreFilter`  [INFERRED]
  tests/test_bias_filter.py → src/butterfly_guy/strategy/bias_filter.py
- `TestComputeVwap` --uses--> `DayData`  [INFERRED]
  tests/test_bias_filter.py → src/butterfly_guy/backtest/data_loader.py
- `TestComputeVwap` --uses--> `SimulationEngine`  [INFERRED]
...
Cohesion: 0.13
Nodes (28): StrategySettings, ButterflyCandidate, OptionQuote, A single option quote from a chain snapshot., A butterfly spread candidate identified by the scanner., main(), EntryDecision, find_entry_candidate() (+20 more)
...
Cohesion: 0.1
Nodes (21): SweepConfig, DayResult, _drawdown_rule(), DrawdownWindow, _profit_exit_reason(), Single-day simulation engine using synthetic option chains., Simulate one trading day., Simulate one trading day. (+13 more)

### Community 20 - "Community 20"
Cohesion: 0.12
Nodes (15): DayData, Backtest data loader — fetches SPX 1-min bars and VIX from Polygon.io., Runs full strategy on a single day using synthetic options., Runs full strategy on a single day using synthetic options., SimulationEngine, SimulationParams, test_drawdown_rule_prefers_explicit_schedule_when_present(), test_drawdown_rule_uses_legacy_regimes_by_default() (+7 more)
...
Cohesion: 0.1
Nodes (16): fly_mark_value(), Pydantic models for option data and trade records., Butterfly value at mark: lower.mark - 2*center.mark + upper.mark., A trade record for tracking entry/exit., TradeRecord, PositionManager, Tracks position value from chain data and manages peak tracking., Reset for a new position. Optionally restore a persisted peak (e.g. after restar (+8 more)
...
Cohesion: 0.2
Nodes (16): ButterflyBuilder, Builds and scores butterfly spreads from an option chain snapshot., Builds and scores butterfly spreads from an option chain snapshot., make_chain(), make_quote(), Tests for the butterfly builder scanner., Generate a synthetic chain of call quotes around spot., Generate a synthetic chain of call quotes around spot. (+8 more)
...
Cohesion: 0.16
Nodes (10): get_0dte_expiration(), now_eastern(), Current time in US/Eastern., Get today's date as the 0-DTE expiration (SPX has daily expirations)., Fetch current chain and store snapshot. Returns row count., Main collector loop — runs while market is open., Record trade exit metrics and update risk engine., Record trade exit metrics and update risk engine. (+2 more)

### Community 42 - "Community 42"
Cohesion: 0.14
Nodes (11): iter_chain_options(), Shared utilities for parsing Schwab option chain responses., Yield (strike, option_type, opt_dict) for each option matching the expiration., Extract the three butterfly leg quotes from the chain for position valuation., Extract the three butterfly leg quotes from the chain for position valuation., Parse Schwab chain response into OptionQuote objects., Parse Schwab chain response into OptionQuote objects., Parse Schwab chain response into OptionQuote objects. (+3 more)
...
- **Why does `OptionQuote` connect `Community 7` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 40`, `Community 8`, `Community 42`, `Community 15`, `Community 17`, `Community 25`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `TradeService` connect `Community 7` to `Community 32`, `Community 1`, `Community 27`, `Community 73`, `Community 42`, `Community 10`, `Community 43`, `Community 13`, `Community 21`, `Community 22`, `Community 54`, `Community 56`, `Community 25`, `Community 59`, `Community 30`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 7` to `Community 1`, `Community 68`, `Community 73`, `Community 10`, `Community 43`, `Community 74`, `Community 78`, `Community 18`, `Community 19`, `Community 30`, `Community 21`, `Community 54`, `Community 22`, `Community 56`, `Community 57`, `Community 25`, `Community 27`, `Community 62`?**
