...
## Corpus Check
- 286 files · ~332,122 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4519 nodes · 12409 edges · 206 communities (188 shown, 18 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 1056 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `789d8c3a`
...
Cohesion: 0.11
Nodes (33): resolve_db_dsn(), _butterfly_value(), detect_complete_days(), _elapsed(), _et(), get_prev_close(), get_vix(), load_bars_from_db() (+25 more)

### Community 1 - "token_manager.py"
Cohesion: 0.06
Nodes (42): AbstractContextManager, RLock, _AtomicFileTokenTransaction, AtomicTokenManager, _fsync_directory(), Any, datetime, Enum (+34 more)

### Community 2 - "TradeRecord"
Cohesion: 0.10
Nodes (33): A trade record for tracking entry/exit., TradeRecord, _expired_trade_has_broker_settlement(), broker_cash_settlement_from_transactions(), BrokerCashSettlement, final_regular_session_close_from_candles(), Any, date (+25 more)
...
Cohesion: 0.10
Nodes (49): Return the direct read always; compare a gateway read alongside it when…, Wait for any in-flight shadow comparisons to finish. Not used on the…, ShadowComparingMarketDataProvider, chain_response(), _comparisons(), DirectProvider, _discrepancies(), FailingDirectProvider (+41 more)

### Community 5 - "GatewayMarketDataClient"
Cohesion: 0.11
Nodes (42): GatewayMarketDataClient, AsyncClient, Typed client for gateway market-data endpoints only., DirectSchwabChainMetadataUpstream, DirectSchwabSpotUpstream, Normalize a spot read from the direct adapter inside the gateway boundary., Summarize a chain read from the direct adapter; contract rows never leave here., app() (+34 more)
...
Cohesion: 0.13
Nodes (37): SchwabSettings, asyncio, MonkeyPatch, _reload_client(), _reload_harness(), _settings(), test_close_releases_live_and_retired_clients(), test_failed_reload_keeps_the_working_client_and_marker() (+29 more)
...
Cohesion: 0.05
Nodes (68): _as_float(), _as_int(), Any, date, Convert option_chain_snapshots rows into OptionQuote objects., Build OptionQuote list from option_chain_snapshots query rows., rows_to_option_quotes(), ButterflyCandidate (+60 more)
...
Cohesion: 0.06
Nodes (83): max_consecutive_losses(), max_drawdown(), _asset_drawdowns(), backtest_entry_price(), candidate_from_trade_row(), day_with_monitoring_bars(), _dd_schedule_label(), discover_dates() (+75 more)

### Community 17 - "MinuteBar"
Cohesion: 0.06
Nodes (37): day_cache_path(), load_day(), date, Path, JSON cache helpers for DayData — shared across Schwab and future loaders., save_day(), CSV-based data loader for historical SPX + VIX 1-minute data. Reads two CSV…, DayData (+29 more)
...
### Community 19 - "TokenManagerState"
Cohesion: 0.08
Nodes (35): _closing_session(), GatewayUpstreamSettings, LockedSchwabMarketDataProvider, Any, BaseSettings, date, field_validator, Path (+27 more)
...
Cohesion: 0.09
Nodes (33): Enum, authentication_middleware(), hash_api_key(), InternalKeyAuthenticator, InternalPrincipal, middleware, Path, Request (+25 more)

### Community 23 - "SimulationParams"
Cohesion: 0.12
Nodes (20): datetime, Runs full strategy on a single day using synthetic options., Simulate one trading day., Simulate intraday using BS pricing, pinned to a pre-selected real entry. Skips…, Paper trading commission: 4 legs × quantity × rate., Paper close fill at mark minus slippage and four-leg commission., SimulationEngine, SimulationParams (+12 more)
...
Cohesion: 0.14
Nodes (34): archive_report_json(), build_report(), _direction_emoji(), _fmt_news(), _fmt_pct(), _fmt_price(), _fmt_quality(), _fmt_rvol() (+26 more)

### Community 26 - "SnapshotIdentity"
Cohesion: 0.07
Nodes (21): Paper-only SPX candidate fleet fed by a shared market-data service., RuntimeError, No complete snapshot is currently available., A long poll completed normally before a newer snapshot was published., Auditable final regular-session SPX close supplied by the shared feed., SessionClose, SnapshotIdentity, SnapshotUnavailableError (+13 more)

### Community 27 - "StrategySettings"
Cohesion: 0.07
Nodes (63): StrategySettings, main(), parse_args(), print_help(), Inspect what the strategy saw at entry for a given date. Replicates the…, fmt_candidate(), get_prev_close(), get_vix() (+55 more)

### Community 28 - "upstream.py"
Cohesion: 0.06
Nodes (48): CollectorMarketDataProvider, EquityQuoteProvider, OptionChainProvider, Protocol, The read-only surface required by ``OptionChainCollector``., SpotPriceProvider, ChainMetadataV1, datetime (+40 more)

### Community 29 - "extract_chain_metadata"
Cohesion: 0.10
Nodes (40): iter_chain_options(), date, Yield (strike, option_type, opt_dict) for each option matching the expiration.…, ChainMetadataFields, _count_expiration(), _epoch_millis(), extract_chain_metadata(), Any (+32 more)
...
Cohesion: 0.06
Nodes (71): ProfitManagementStrategy, ProfitManagementSettings, ProfitProtectorSettings, QuoteQualitySettings, PositionState, Current state of an open position., effective_drawdown_threshold(), ProfitPolicyDecision (+63 more)
...
### Community 42 - "api.py"
Cohesion: 0.12
Nodes (35): Transport-neutral client contracts for the internal Schwab gateway., ChainMetadataResponseV1, GatewayErrorDetailV1, GatewayErrorV1, GatewayHealthV1, GatewayModel, GatewayReadinessV1, BaseModel (+27 more)
...
Cohesion: 0.13
Nodes (13): trade_pnl_dollars(), _load_trade(), main(), Generate entry + EOD charts from a historic trade and post to Discord., load_spot_series(), date, Load spot price series from TimescaleDB for chart generation., spot_rows_to_candles() (+5 more)

### Community 45 - "test_schwab_token_keepalive.py"
Cohesion: 0.07
Nodes (27): fixture, asyncio, parametrize, Tests for Discord trade notifications., test_alertmanager_failed_resolution_retries_until_accepted(), test_alertmanager_new_firing_cancels_stale_pending_resolution(), test_alertmanager_payload_has_stable_redacted_fingerprint(), test_notify_entry_includes_trade_stats() (+19 more)
...
Cohesion: 0.14
Nodes (34): _keys_file(), Any, asyncio, parametrize, Path, Tests for the gateway runner's demo and live modes. No test here reads a real…, Refusal happens in argparse, before any setting, key file, or token is touched., The readiness surface must reflect the real token manager, not a static fake. (+26 more)
...
Cohesion: 0.10
Nodes (15): _aware_utc(), MarketSnapshot, datetime, Immutable normalized market snapshots shared by candidate evaluators., One atomically published, replayable view of candidate market data., StaleSnapshotError, _gauge_value(), MetricsPool (+7 more)

### Community 57 - "time_utils.py"
Cohesion: 0.04
Nodes (81): _easter_sunday(), get_0dte_expiration(), get_time_regime(), get_us_market_early_closes(), get_us_market_holidays(), is_market_open(), is_trading_day(), _last_weekday() (+73 more)
...
Cohesion: 0.24
Nodes (18): create_app(), __getattr__(), Any, Read-only Schwab gateway foundation., Import ``api`` lazily so the reviewed credential-proof subset loads standalone., authenticator(), FakeQuoteUpstream, FakeTokenReadinessProvider (+10 more)

### Community 62 - "shadow.py"
Cohesion: 0.16
Nodes (19): GatewayAuthenticationError, GatewayAuthorizationError, GatewayCapacityError, GatewayClientError, GatewayResponseError, GatewayTimeoutError, GatewayUnavailableError, date (+11 more)
...
Cohesion: 0.21
Nodes (13): Any, asyncio, datetime, quote(), snapshot(), test_atomic_store_sequence_and_boot_instance_change(), test_lease_cadence_and_ttl_expiry(), test_long_poll_never_replays_same_sequence() (+5 more)

### Community 66 - "universes.py"
Cohesion: 0.06
Nodes (59): _as_float(), build_liquid_meta(), extract_quote_price(), fetch_exchange_seed_map(), fetch_nasdaq_listed_symbols(), fetch_nq100_tickers(), fetch_nyse_listed_symbols(), fetch_sp500_rows() (+51 more)
...
### Community 70 - "simulation_engine.py"
Cohesion: 0.11
Nodes (21): DayResult, DrawdownWindow, Single-day simulation engine using synthetic option chains., Classify regime then delegate to simulate_day() with matching params. Returns…, Maps Regime → SimulationParams for use with simulate_day_adaptive(). Per-regime…, RegimeDispatch, TimeRegime, GapRegimeFilter (+13 more)
...
Cohesion: 0.09
Nodes (34): is_premarket_window(), True during weekday premarket (default 4:00–9:30 AM ET)., load_equity_scan_config(), Path, Load equity scan settings from YAML., archive_report(), Path, Write the scan report to a dated markdown file under report_dir. (+26 more)
...
### Community 86 - "AtomicFileTokenStore"
Cohesion: 0.12
Nodes (28): ClientT, GatewayCredentialProbeReason, OperationResult, GatewayCredentialProbeError, GatewayCredentialProbeResult, Any, RuntimeError, One bounded quote proof through the locked token adapter. (+20 more)
...
Cohesion: 0.03
Nodes (78): Pool, assert_candidate_safety(), candidate_performance_stats(), CandidateAuditContext, CandidateDecisionQueries, CandidateEvaluator, CandidatePaperExecutor, CandidatePerformanceStats (+70 more)
...
Cohesion: 0.10
Nodes (19): Candidate-feed authentication proven (2026-08-10), Candidate-feed hot reload built locally (2026-08-10, NOT deployed), Codex Project State, Current Phase, Current Slice, Decisions Made, Known Failures, Live Finding — SPX is on a divergent orphaned token document (2026-08-06, RETIRED 2026-08-08) (+11 more)

### Community 96 - "Re-authorization checklist — Saturday 2026-08-15"
Cohesion: 0.13
Nodes (14): Before you start, First, watch the reload do its job, Re-authorization checklist — Saturday 2026-08-15, Step 0 — already done, nothing to do, Step 1 — mint the token on zeus, in a real terminal, Step 2 — stage on Helios and verify byte-identical, Step 3 — move into place under the C1 lock, Step 4 — restart the consumers that actually cache the token (+6 more)
...
Cohesion: 0.11
Nodes (7): DirectSchwabMarketDataProvider, PriceHistoryProvider, Any, date, Delegate to the current client without owning its lifecycle or changing data., asyncio, test_direct_provider_delegates_without_transforming_results()
...
### Community 101 - "entry_pricing.py"
Cohesion: 0.33
Nodes (5): capped_entry_limit(), Shared entry-price limit policy for production and candidate runtimes., Return a cent-valid debit limit that never exceeds the configured maximum., test_capped_entry_limit_never_rounds_above_configured_maximum(), test_entry_fill_limit_comparison_is_decimal_safe()
...
Cohesion: 0.34
Nodes (14): CaptureFixture, parametrize, Path, Tests for the internal gateway key issuer. Every key here is generated by the…, _run(), test_an_unissued_key_does_not_authenticate(), test_each_run_issues_distinct_keys(), test_existing_output_is_never_overwritten() (+6 more)
...
### Community 109 - "BrokerStateGate"
Cohesion: 0.07
Nodes (61): clear_readiness(), Prometheus metrics for monitoring., Add a not-ready reason; ``None`` explicitly resets all reasons., Clear only the recovered subsystem's not-ready reason., readiness_snapshot(), set_readiness(), _assert_broker_state_matches_db(), _broker_option_positions() (+53 more)
...
### Community 121 - ".attempt_entry"
Cohesion: 0.21
Nodes (5): candidate_fill_parity_failures(), _candidate_mark(), Any, Count mark_v1 rows whose fills disagree with their recorded evidence., _restore_trade()
...
Cohesion: 0.20
Nodes (9): Candidate-feed reload follow-up (2026-08-10), Recommendation, Reducing the weekly re-authorization cost — a scoping question, Status, The alternative worth costing first, The brief's proposed remedy, and why it is weaker than it looks, The cost being attacked, The questions to answer before building either (+1 more)
...
Cohesion: 0.06
Nodes (58): AppConfig, CollectorSettings, ConfigModel, EntrySettings, ExecutionSettings, MonitoringSettings, PeakTrackingSettings, BaseModel (+50 more)
...
### Community 137 - "issue_gateway_keys.py"
Cohesion: 0.29
Nodes (9): build_keys_document(), generate_key(), key_digest(), main(), Path, Issue internal gateway consumer keys and write the digest-only keys file. The…, Return the digest-only document and the plaintext keys, keyed by client id., Create the file at mode 0600, refusing to overwrite an existing path. (+1 more)
...
### Community 141 - "SchwabClientWrapper"
Cohesion: 0.03
Nodes (95): BoundLogger, Schwab market-data client deliberately lacking every account/order operation., entry_fill_within_limit(), Return whether an entry fill respects its hard debit ceiling., get_logger(), Structured logging setup with structlog., Get a structlog logger with optional name., now_utc() (+87 more)
...
### Community 143 - "GatewaySettings"
Cohesion: 0.12
Nodes (16): NoReturn, GatewayCredentialProbeSettings, GatewaySettings, BaseSettings, field_validator, Path, Validated configuration for the isolated gateway process., Explicit real-credential inputs for the standalone quote proof only. (+8 more)
...
### Community 158 - "report_selection_parity.py"
Cohesion: 0.38
...
## Knowledge Gaps
- **506 isolated node(s):** `butterfly-guy`, `run_live_performance_cron.sh script`, `run_morning_scan_cron.sh script`, `Objective`, `Current Phase` (+501 more)
...
- **Why does `SchwabClientWrapper` connect `SchwabClientWrapper` to `TradeRecord`, `test_order_manager.py`, `AppConfig`, `SchwabSettings`, `record_equity_market_data.py`, `ButterflyCandidate`, `test_gateway_live_provider.py`, `backfill_equity_candles.py`, `upstream.py`, `api.py`, `time_utils.py`, `universes.py`, `run_morning_scan.py`, `AtomicFileTokenStore`, `report_broker_order_statuses.py`, `DatabasePool`, `DirectSchwabMarketDataProvider`, `BrokerStateGate`, `services/daily_report_card.py`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `SchwabClientWrapper` to `run_paper_replay.py`, `token_manager.py`, `ButterflyCandidate`, `run_backtest_db.py`, `MinuteBar`, `TokenManagerState`, `StrategySettings`, `ProfitStateMachine`, `news.py`, `run_classifier_sweep.py`, `api.py`, `AtomicSnapshotStore`, `DiscordNotifier`, `time_utils.py`, `shadow.py`, `universes.py`, `feed.py`, `run_morning_scan.py`, `weekend_review.py`, `AtomicFileTokenStore`, `DatabasePool`, `services/daily_report_card.py`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `OptionQuote` connect `ButterflyCandidate` to `run_paper_replay.py`, `TradeRecord`, `test_order_manager.py`, `AppConfig`, `SchwabClientWrapper`, `run_backtest_db.py`, `MinuteBar`, `FakeProvider`, `SnapshotIdentity`, `StrategySettings`, `ProfitStateMachine`, `SyntheticChainGenerator`, `AtomicSnapshotStore`, `report_exit_mark_parity.py`, `MarketSnapshot`, `time_utils.py`, `test_candidate_snapshot.py`, `DbDataLoader`, `feed.py`, `ChainDay`, `DatabasePool`, `.handler`?**
