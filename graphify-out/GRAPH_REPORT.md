# Graph Report - Butterflyguy  (2026-08-24)

## Corpus Check
- 259 files · ~307,338 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3584 nodes · 8711 edges · 206 communities (188 shown, 18 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 823 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f258445`
...
Cohesion: 0.09
Nodes (38): resolve_db_dsn(), _butterfly_value(), _compute_spread(), detect_complete_days(), _elapsed(), _et(), get_prev_close(), get_vix() (+30 more)

### Community 1 - "order_manager.py"
Cohesion: 0.08
Nodes (38): entry_fill_within_limit(), Shared entry-price limit policy for production and candidate runtimes., Return whether an entry fill respects its hard debit ceiling., get_0dte_expiration(), now_utc(), Get today's date as the 0-DTE expiration (SPX has daily expirations)., OptionChainProvider, AmbiguousOrderError (+30 more)

### Community 2 - "run_live.py"
Cohesion: 0.04
Nodes (79): BoundLogger, Pool, CSV-based data loader for historical SPX + VIX 1-minute data. Reads two CSV…, Backtest data loader using Schwab (1-min SPY bars) + yfinance (daily data).…, Schwab market-data client deliberately lacking every account/order operation., get_logger(), Structured logging setup with structlog., Configure structlog with JSON output and correlation IDs. (+71 more)

### Community 3 - "test_order_manager.py"
Cohesion: 0.17
Nodes (54): LiveSpread, broker_fill(), make_candidate(), make_chain_data(), make_chain_data_with_oi(), make_chain_data_with_spread(), make_order_manager(), make_quote() (+46 more)
...
Cohesion: 0.17
Nodes (23): build_entry_chart_png(), build_exit_chart_png(), ButterflyChartSpec, candles_to_series(), _draw_strike_overlays(), _exit_chart_series(), _exit_marker_point(), _exit_window_end() (+15 more)
...
### Community 8 - "trade_service.py"
Cohesion: 0.16
Nodes (19): capped_entry_limit(), Return a cent-valid debit limit that never exceeds the configured maximum., _age_seconds(), datetime, Trade service — orchestrates entry flow., Compare Schwab selection with the nearest DB collector snapshot., EntrySelectionResult, build_entry_selection_parity() (+11 more)
...
### Community 10 - ".monitor_loop"
Cohesion: 0.10
Nodes (19): broker_cash_settlement_from_transactions(), BrokerCashSettlement, _chain_spot_price(), Any, date, datetime, NamedTuple, RuntimeError (+11 more)

### Community 11 - "test_run_live.py"
Cohesion: 0.10
Nodes (40): broker_reconciler_loop(), _build_collector_market_data(), _close_runtime_resources(), install_shutdown_handler(), GatewayClientSettings, GatewayMarketDataClient, Task, Select one authoritative read path without changing broker boundaries. (+32 more)

### Community 12 - "PositionService"
Cohesion: 0.16
Nodes (30): readiness_snapshot(), A trade record for tracking entry/exit., TradeRecord, final_regular_session_close_from_candles(), PositionService, Return the latest Schwab 1-minute close in the regular session., Monitors open positions and manages exits via the profit state machine., Record trade exit metrics and update risk engine. (+22 more)

### Community 13 - "AtomicSnapshotStore"
Cohesion: 0.14
Nodes (8): AtomicSnapshotStore, Condition-guarded pointer swap; readers never observe partial snapshots., SnapshotArchive, DatabaseSettings, main(), Run the demand-aware shared SPX candidate market-data feed., Pick up a re-authorized token while retaining a working client on failure., token_reload_loop()
...
Cohesion: 0.10
Nodes (23): assert_candidate_safety(), _candidate_mark(), candidate_performance_stats(), CandidateAuditContext, CandidateDecisionQueries, CandidatePerformanceStats, config_sha256(), Path (+15 more)
...
Cohesion: 0.12
Nodes (23): DayData, DayResult, datetime, Runs full strategy on a single day using synthetic options., Simulate one trading day., Simulate intraday using BS pricing, pinned to a pre-selected real entry. Skips…, Classify regime then delegate to simulate_day() with matching params. Returns…, Paper trading commission: 4 legs × quantity × rate. (+15 more)
...
Cohesion: 0.15
Nodes (30): archive_report_json(), build_report(), _direction_emoji(), _fmt_news(), _fmt_pct(), _fmt_price(), _fmt_quality(), _fmt_rvol() (+22 more)

### Community 26 - "MarketSnapshot"
Cohesion: 0.12
Nodes (8): CandidatePaperExecutor, Any, Mark-price fills only; this object intentionally has no broker methods., _aware_utc(), MarketSnapshot, datetime, One atomically published, replayable view of candidate market data., StaleSnapshotError
...
### Community 28 - "run_single"
Cohesion: 0.12
Nodes (28): backtest_entry_price(), _dd_schedule_label(), _live_width_label(), load_asset_config(), main(), merge_chains(), _patch_chain_cache(), _print_same_entry_comparison_table() (+20 more)
...
### Community 30 - "core/config.py"
Cohesion: 0.17
Nodes (19): ProfitManagementStrategy, CollectorSettings, ConfigModel, MonitoringSettings, PeakTrackingSettings, ProfitManagementSettings, ProfitProtectorSettings, BaseModel (+11 more)

### Community 31 - "SchwabSettings"
Cohesion: 0.19
...
Cohesion: 0.10
Nodes (41): QuoteQualitySettings, PositionState, Current state of an open position., ExitSignal, ProfitState, ProfitStateMachine, Enum, Transition between profit states. (+33 more)
...
### Community 37 - "record_equity_market_data.py"
Cohesion: 0.33
...
### Community 38 - "is_market_open"
Cohesion: 0.17
Nodes (21): is_market_open(), is_trading_day(), Check if the market is currently open., Check if a given date is a trading day (weekday, not a holiday)., Check if current time is within the given window (HH:MM strings)., time_in_window(), et(), datetime (+13 more)
...
### Community 41 - "time_utils.py"
Cohesion: 0.17
Nodes (20): _easter_sunday(), get_us_market_early_closes(), get_us_market_holidays(), _last_weekday(), market_close_time(), minutes_since_open(), minutes_to_close(), now_pacific() (+12 more)
...
Cohesion: 0.10
Nodes (43): discover_dates(), _duration_min(), _find_bar_at(), _find_entry_bar_at(), find_entry_in_window(), _force_synthetic_for_date(), _format_et(), get_prev_close() (+35 more)
...
### Community 48 - "report_exit_mark_parity.py"
Cohesion: 0.26
...
### Community 54 - "RegimeFilter"
Cohesion: 0.32
Nodes (5): datetime, Filter entries based on intraday VIX level at the time of entry., Most recent VIX bar close at or before entry_ts. None if no bars., True = safe to trade. False = skip (VIX too high). Returns True if no VIX bars…, RegimeFilter
...
Cohesion: 0.10
Nodes (37): StrategySettings, main(), parse_args(), print_help(), Inspect what the strategy saw at entry for a given date. Replicates the…, EntryDecision, find_entry_candidate(), Find best candidate in the 10:00–10:30 ET window, returning full decision… (+29 more)

### Community 57 - "OptionQuote"
Cohesion: 0.06
Nodes (61): Shared backtest market-data models., DB-backed data loader for historical SPX + VIX data. Reads from the live…, Single-day simulation engine using synthetic option chains., _as_float(), _as_int(), Any, date, Convert option_chain_snapshots rows into OptionQuote objects. (+53 more)
...
Cohesion: 0.08
Nodes (46): BaseSettings, AppConfig, EntrySettings, ExecutionSettings, model_validator, RiskSettings, now_eastern(), Current time in US/Eastern. (+38 more)
...
Cohesion: 0.16
Nodes (24): _as_float(), _as_int(), attach_news_impacts(), EquitySnapshot, filter_movers(), _focus_reasons(), _mid_bid_ask(), _mover_change_pct() (+16 more)
...
### Community 74 - "ButterflyCandidate"
Cohesion: 0.08
Nodes (31): CandidateEvaluator, _restore_trade(), get_time_regime(), Classify minutes since open into a named time regime., ButterflyCandidate, A butterfly spread candidate identified by the scanner., compute_tent_boundaries(), fly_bid_value() (+23 more)
...
Cohesion: 0.09
Nodes (30): is_premarket_window(), True during weekday premarket (default 4:00–9:30 AM ET)., load_equity_scan_config(), Path, Load equity scan settings from YAML., archive_report(), Path, Write the scan report to a dated markdown file under report_dir. (+22 more)
...
### Community 93 - "test_trade_chart.py"
Cohesion: 0.16
Nodes (17): entry_chart_window(), parse_hhmm(), date, time, Return [start_time - lookback, max(start_time, fill)] in the entry timezone., date, Tests for Discord trade chart generation., _sample_candles() (+9 more)
...
### Community 100 - "set_readiness"
Cohesion: 0.14
Nodes (15): clear_readiness(), Add a not-ready reason; ``None`` explicitly resets all reasons., Clear only the recovered subsystem's not-ready reason., set_readiness(), BrokerStateGate, entry_loop(), Periodically attempt entries during the entry window., Pick up a re-authorized Schwab token without restarting the container. schwab-… (+7 more)
...
### Community 107 - "download_schwab_cache.py"
Cohesion: 0.27
...
### Community 110 - "test_candidate_variants.py"
Cohesion: 0.42
...
### Community 120 - "select_cross_width_candidate"
Cohesion: 0.48
...
### Community 132 - "MinuteBar"
Cohesion: 0.20
Nodes (10): MinuteBar, Fetch today's 1-min bars from Schwab and run BiasScoreFilter., BiasScoreFilter, Scores market direction using 4 signals; returns CALL, PUT, or None., Bars that produce strong bullish score: rising price, above OR high., Bars that produce strong bearish score: falling price, below OR low., OR signal is ±2 — alone it meets the ±2 threshold., Gap signal only contributes +1, below the ±2 threshold. (+2 more)
...
### Community 136 - "parse_broker_fill"
Cohesion: 0.47
Nodes (6): parse_broker_fill(), Return a validated net butterfly fill derived only from broker executions., filled_order(), test_captured_trade_177_fill_uses_execution_net_not_limit(), test_fill_parser_combines_multiple_activities_and_nested_executions(), test_fill_parser_fails_closed_on_incomplete_or_inconsistent_evidence()

### Community 137 - "providers.py"
Cohesion: 0.06
Nodes (53): DirectSchwabMarketDataProvider, EquityQuoteProvider, _finite_number(), GatewayAuthoritativeMarketDataProvider, GatewayMarketDataError, MarketMoversProvider, _nonnegative_integer(), _now_eastern() (+45 more)

### Community 138 - "notify.py"
Cohesion: 0.33
...
### Community 139 - "send_weekend_review.py"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (20): DrawdownWindow, _asset_drawdowns(), candidate_from_trade_row(), _floatlist(), _intlist(), parse_args(), _parse_dd_schedule(), Use the first regular-session snapshot for gap direction. (+12 more)
...
### Community 205 - ".collect_snapshot"
Cohesion: 0.18
...
## Knowledge Gaps
- **497 isolated node(s):** `butterfly-guy`, `run_live_performance_cron.sh script`, `run_morning_scan_cron.sh script`, `Objective`, `Current status — 2026-08-10` (+492 more)
...
- **Why does `ButterflyCandidate` connect `ButterflyCandidate` to `run_paper_replay.py`, `order_manager.py`, `run_live.py`, `test_order_manager.py`, `trade_service.py`, `.monitor_loop`, `PositionService`, `evaluator.py`, `test_candidate_executor.py`, `SimulationEngine`, `MarketSnapshot`, `parse_args`, `run_backtest_db.py`, `StrategySettings`, `OptionQuote`, `ButterflyOrderBuilder`, `AppConfig`, `set_readiness`, `test_candidate_variants.py`, `select_cross_width_candidate`, `test_candidate_settlement.py`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `OptionQuote` connect `OptionQuote` to `run_paper_replay.py`, `run_live.py`, `test_order_manager.py`, `test_candidate_provider.py`, `trade_service.py`, `.monitor_loop`, `PositionService`, `AtomicSnapshotStore`, `test_candidate_snapshot.py`, `test_candidate_executor.py`, `MarketSnapshot`, `feed.py`, `SyntheticChainGenerator`, `run_backtest_db.py`, `report_exit_mark_parity.py`, `CandidateFeed`, `SessionClose`, `StrategySettings`, `DbDataLoader`, `AppConfig`, `ButterflyCandidate`, `ChainDay`, `SnapshotIdentity`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `SchwabClientWrapper` connect `SchwabClientWrapper` to `order_manager.py`, `run_live.py`, `trade_service.py`, `providers.py`, `test_run_live.py`, `PositionService`, `evaluator.py`, `SchwabSettings`, `record_equity_market_data.py`, `._retry`, `backfill_equity_candles.py`, `main`, `universes.py`, `AppConfig`, `run_morning_scan.py`, `set_readiness`, `_assert_broker_state_matches_db`, `services/daily_report_card.py`, `report_broker_order_statuses.py`?**
