...
## Corpus Check
- 112 files · ~286,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1712 nodes · 2895 edges · 124 communities (109 shown, 15 thin omitted)
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 791 edges (avg confidence: 0.7)
...
7. `StrategySettings` - 38 edges
8. `SimulationParams` - 37 edges
...
Cohesion: 0.5
Nodes (3): ChainDay, dict of {UTC datetime: OptionQuote list} with a pre-sorted key index for O(log n, load_chains_from_db()
