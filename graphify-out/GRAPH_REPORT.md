...
## Corpus Check
- 274 files · ~281,030 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3840 nodes · 10420 edges · 184 communities (170 shown, 14 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 776 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a472b3d`
...
Cohesion: 0.10
Nodes (41): ButterflyCandidate, A butterfly spread candidate identified by the scanner., Any, Build a butterfly BUY_TO_OPEN order., Build a butterfly SELL_TO_CLOSE order., _butterfly_value(), _compute_spread(), detect_complete_days() (+33 more)
...
### Community 4 - "core/config.py"
Cohesion: 0.15
Nodes (23): CollectorSettings, ConfigModel, DatabaseSettings, EntrySettings, MonitoringSettings, PeakTrackingSettings, BaseModel, Configuration management using Pydantic settings. (+15 more)

### Community 5 - "position_service.py"
Cohesion: 0.07
Nodes (48): A trade record for tracking entry/exit., TradeRecord, MonitoringLegQueries, Queries for high-frequency live monitor quotes of open-position legs., Queries for tent_boundaries table., TentQueries, broker_cash_settlement_from_transactions(), BrokerCashSettlement (+40 more)

### Community 6 - "trade_chart.py"
Cohesion: 0.18
Nodes (24): build_entry_chart_png(), build_exit_chart_png(), candles_to_series(), _draw_strike_overlays(), entry_chart_window(), _exit_chart_series(), _exit_marker_point(), _exit_window_end() (+16 more)
...
### Community 19 - "run_single"
Cohesion: 0.13
Nodes (29): backtest_entry_price(), _dd_schedule_label(), find_entry_in_window(), _live_width_label(), load_asset_config(), load_live_trades(), load_monitoring_chains(), main() (+21 more)

### Community 20 - "run_live.py"
Cohesion: 0.15
Nodes (32): _assert_broker_state_matches_db(), _broker_option_positions(), eod_chart_loop(), _expired_trade_has_broker_settlement(), _explicit_fill_details(), _intent_order_ids(), _json_dict(), _matches_underlying() (+24 more)
...
Cohesion: 0.09
Nodes (30): candidate_performance_stats(), CandidateAuditContext, CandidateDecisionQueries, CandidatePaperExecutor, CandidatePerformanceStats, Paper-only candidate evaluator built without broker execution dependencies., Summarize one chronological, closed mark_v1 PnL cohort., Mark-price fills only; this object intentionally has no broker methods. (+22 more)

### Community 27 - "StrategySettings"
Cohesion: 0.12
Nodes (30): StrategySettings, main(), parse_args(), print_help(), Inspect what the strategy saw at entry for a given date. Replicates the…, EntryDecision, find_entry_candidate(), Find best candidate in the 10:00–10:30 ET window, returning full decision… (+22 more)
...
Cohesion: 0.16
Nodes (25): fmt_candidate(), get_prev_close(), get_vix(), load_bars_from_db(), load_chains_from_db(), main(), nearest_snapshot(), parse_args() (+17 more)
...
Cohesion: 0.07
Nodes (44): compute_tent_boundaries(), Position value tracking and management., Find the two spot prices where the fly's BS mark equals entry cost. These are…, bs_call_price(), bs_delta(), bs_gamma(), bs_put_price(), bs_theta() (+36 more)
...
### Community 40 - "MarketSnapshot"
Cohesion: 0.12
Nodes (12): candidate_fill_parity_failures(), _candidate_mark(), CandidateEvaluator, Any, Count mark_v1 rows whose fills disagree with their recorded evidence., _restore_trade(), _aware_utc(), MarketSnapshot (+4 more)
...
### Community 44 - "RiskQueries"
Cohesion: 0.09
Nodes (21): RiskSettings, Calendar date for the US/Eastern trading session., session_date(), Queries for daily_risk_state table., Dollar PnL for the rolling 7-day window (closed trades only)., Dollar PnL of the last N closed trades, most recent first., RiskQueries, ConsecutiveLossNotifier (+13 more)
...
Cohesion: 0.14
Nodes (22): assert_candidate_safety(), AppConfig, ExecutionSettings, BaseSettings, model_validator, _assert_live_config_supported(), asyncio, Integration tests for the option chain collector (requires live Schwab token). (+14 more)

### Community 49 - "load_date_data"
Cohesion: 0.14
Nodes (25): discover_dates(), _find_bar_at(), _find_entry_bar_at(), _force_synthetic_for_date(), get_prev_close(), get_recent_closes(), get_vix_at(), get_vix_prev_close() (+17 more)
...
Cohesion: 0.06
Nodes (83): max_drawdown(), chart_payload(), compute_stats(), cumulative_equity(), drawdown_series(), DrawdownPoint, duration_minutes(), format_et_time() (+75 more)
...
Cohesion: 0.06
Nodes (118): docker_inspect(), CaptureFixture, MonkeyPatch, parametrize, Path, test_canonical_fingerprint_is_independent_of_semantically_unordered_fields(), test_cli_bounds_docker_failure_without_raw_exception(), test_cli_exact_and_staging_verification_are_bounded() (+110 more)
...
Cohesion: 0.16
Nodes (23): is_market_open(), is_trading_day(), minutes_to_close(), Check if the market is currently open., Check if a given date is a trading day (weekday, not a holiday)., Check if current time is within the given window (HH:MM strings)., Minutes remaining until market close., time_in_window() (+15 more)

### Community 58 - "run_classifier_sweep.py"
Cohesion: 0.21
...
### Community 60 - "SyntheticChainGenerator"
Cohesion: 0.25
...
Cohesion: 0.10
Nodes (19): Persist once and return the canonical evidence for this session., Any, Auditable final regular-session SPX close supplied by the shared feed., SessionClose, date, Direct-provider adapter for primary/parity paths that normalize Schwab data., SchwabMarketDataProvider, asyncio (+11 more)
...
Cohesion: 0.07
Nodes (29): capped_entry_limit(), entry_fill_within_limit(), Shared entry-price limit policy for production and candidate runtimes., Return a cent-valid debit limit that never exceeds the configured maximum., Return whether an entry fill respects its hard debit ceiling., _age_seconds(), Any, date (+21 more)
...
### Community 74 - "state_machine.py"
Cohesion: 0.15
Nodes (11): ProfitManagementSettings, PositionState, Current state of an open position., ExitSignal, ProfitState, Enum, Profit management state machine for butterfly positions., Transition between profit states. (+3 more)
...
### Community 76 - "time_utils.py"
Cohesion: 0.14
Nodes (25): _easter_sunday(), get_0dte_expiration(), get_us_market_early_closes(), get_us_market_holidays(), is_premarket_window(), _last_weekday(), market_close_time(), minutes_since_open() (+17 more)
...
### Community 78 - "test_position_manager.py"
Cohesion: 0.28
...
### Community 82 - "DiscordNotifier"
Cohesion: 0.10
Nodes (30): trade_pnl_dollars(), DiscordNotifier, date, Post one or more plain-text messages (e.g. morning equity scan)., Sends trading notifications to Discord via webhook., ButterflyChartSpec, Strike and timing context for chart overlays., build_eod_chart_for_row() (+22 more)
...
### Community 92 - "schemas.py"
Cohesion: 0.08
Nodes (35): Pydantic models for option data and trade records., _bucket_sigmas(), Return sigma anchors spanning narrow to wide for the bucket size., Return (widths, sigma_fractions) for the active VIX bucket. Buckets are…, resolve_wing_widths_for_vix(), ButterflySelector, Butterfly selector — picks the best candidate from a list., Selects the best butterfly candidate. (+27 more)
...
Cohesion: 0.15
Nodes (21): _asset_drawdowns(), _duration_min(), _floatlist(), _format_et(), _intlist(), parse_args(), _parse_config_time(), _parse_dd_schedule() (+13 more)

### Community 105 - "test_trade_chart.py"
Cohesion: 0.31
Nodes (12): date, Tests for Discord trade chart generation., _sample_candles(), test_build_entry_chart_png_returns_png_bytes(), test_build_exit_chart_png_returns_png_bytes(), test_candles_to_series_sorts_and_converts_timezone(), test_entry_chart_window_caps_end_at_start_when_fill_is_early(), test_entry_chart_window_extends_to_late_fill() (+4 more)

### Community 106 - "DatabasePool"
Cohesion: 0.04
Nodes (66): BoundLogger, Pool, config_sha256(), Path, Schwab market-data client deliberately lacking every account/order operation., get_logger(), Structured logging setup with structlog., Configure structlog with JSON output and correlation IDs. (+58 more)
...
### Community 120 - "test_candidate_variants.py"
Cohesion: 0.42
...
Cohesion: 0.07
Nodes (16): CandidateQueries, ChainQueries, DecisionQueries, Any, date, datetime, Queries for option_chain_snapshots table., Bulk insert option chain snapshot rows using COPY. (+8 more)

### Community 122 - "IVModel"
Cohesion: 0.22
...
Cohesion: 0.12
Nodes (18): HttpMarketDataProvider, AsyncClient, LeaseKind, Response, Fail-closed client for the internal candidate feed., _response_error(), Any, Build a synchronous schwab-py handler that never blocks the stream. (+10 more)
...
### Community 129 - "backfill_equity_candles.py"
Cohesion: 0.46
...
Cohesion: 0.08
Nodes (23): Accepted runtime-baseline proof adapter, Candidate capture safety stop — 2026-08-05, Candidate failure diagnosis and scope correction, Candidate new-baseline capture remediation, Command, Compose-hash ambiguity remediation, Content-verified mount result — 2026-08-05, Corrected candidate capture safety stop — 2026-08-05 (+15 more)
...
### Community 134 - "test_run_backtest_db_defaults.py"
Cohesion: 0.21
...
Cohesion: 0.08
Nodes (37): now_utc(), iter_chain_options(), date, Shared utilities for parsing Schwab option chain responses., Yield (strike, option_type, opt_dict) for each option matching the expiration.…, OrderIntentQueries, Queries for durable broker order intents., AmbiguousOrderError (+29 more)
...
## Knowledge Gaps
- **430 isolated node(s):** `butterfly-guy`, `run_live_performance_cron.sh script`, `run_morning_scan_cron.sh script`, `Objective`, `Current Phase` (+425 more)
...
- **Why does `_restore_argv()` connect `credential_proof_fingerprint.py` to `feed.py`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `DatabasePool` to `ButterflyCandidate`, `token_manager.py`, `position_service.py`, `order_manager.py`, `MinuteBar`, `run_live.py`, `evaluator.py`, `StrategySettings`, `run_entry_analysis.py`, `position_manager.py`, `news.py`, `api.py`, `RiskQueries`, `SchwabDataLoader`, `run_classifier_sweep.py`, `feed.py`, `trade_service.py`, `state_machine.py`, `run_morning_scan.py`, `ButterflyOrderBuilder`, `DiscordNotifier`, `credential_probe.py`, `schemas.py`, `run_backtest_db.py`, `services/daily_report_card.py`, `TokenManagerState`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `OptionQuote` connect `OptionQuote` to `ButterflyCandidate`, `test_order_manager.py`, `position_service.py`, `MinuteBar`, `run_single`, `evaluator.py`, `StrategySettings`, `run_entry_analysis.py`, `position_manager.py`, `MarketSnapshot`, `AtomicSnapshotStore`, `load_date_data`, `report_exit_mark_parity.py`, `SyntheticChainGenerator`, `SessionClose`, `DbDataLoader`, `feed.py`, `trade_service.py`, `state_machine.py`, `chain_cache.py`, `test_position_manager.py`, `schemas.py`, `EntrySelectionResult`, `run_backtest_db.py`, `ChainDay`, `HttpMarketDataProvider`?**
